...
docker run --rm -e BACKEND_URI="http://gimnasio-api:8080" -p 4200:80 gimnasio-ui:0.0.1

### PWA Support

JHipster ships with PWA (Progressive Web App) support, and it's turned off by default. One of the main components of a PWA is a service worker.

The service worker initialization code is disabled by default. To enable it, uncomment the following code in `src/app/app.module.ts`:
...
Edit [src/app/app.module.ts](src/app/app.module.ts) file:

```
import 'leaflet/dist/leaflet.js';
```

Edit [src/content/scss/vendor.scss](src/content/scss/vendor.scss) file:
...
To build the final jar and optimize the gimnasio-ui application for production, run:
...
> docker build -t gimnasio-ui .

tag image:

> docker tag gimnasio-ui k3d-registry.alphalab.cloud:5000/gimnasio-ui:latest

push image to registry

> docker push k3d-registry.alphalab.cloud:5000/gimnasio-ui:latest

deploy app with helm to cluster

> helm upgrade --install -f .cicd/helm/values-prod.yaml gimnasio-ui .cicd/helm
