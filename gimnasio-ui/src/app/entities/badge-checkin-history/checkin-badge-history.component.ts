...
@Component({
  selector: 'jhi-checkin-badge-history',
  templateUrl: './checkin-badge-history.component.html',
  styleUrls: ['./checkin-badge-history.component.scss'],
})
export class CheckinBadgeHistoryComponent implements OnInit {
  checkins?: ICheckin[];
  isLoading = false;
  result: any[] = [];
  closeResult = '';
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.checkinService.queryBySession(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
