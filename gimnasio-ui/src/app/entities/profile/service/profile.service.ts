...
export class ProfileService {
  ...
  findByBadge(id: number): Observable<EntityResponseType> {
    return this.http.get<IProfile>(`${this.resourceUrl}/badge/${id}`, { observe: 'response' });
  }
  ...
  querySingleByAccountSession(req?: any): Observable<EntityResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IProfile>(`${this.resourceUrl}/account`, { params: options, observe: 'response' });
  }
