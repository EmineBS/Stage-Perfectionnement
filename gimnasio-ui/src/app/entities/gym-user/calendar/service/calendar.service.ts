...
export class CalendarService {
  ...
  queryByBadgeSession(req?: any): Observable<EntityResponseType> {
    const options = createRequestOption(req);
    return this.http.get<ICalendar>(`${this.resourceUrl}/badge-account`, { params: options, observe: 'response' });
  }

  findCalendar(id: number, req?: any): Observable<EntityResponseType> {
    const options = createRequestOption(req);
    return this.http.get<ICalendar>(`${this.resourceUrl}/gym/${id}`, { params: options, observe: 'response' });
  }
