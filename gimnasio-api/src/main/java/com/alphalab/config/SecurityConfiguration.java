...
import com.alphalab.security.AuthoritiesConstants;
import com.alphalab.security.SecurityUtils;
import com.alphalab.security.oauth2.AudienceValidator;
import com.alphalab.security.oauth2.JwtGrantedAuthorityConverter;
import com.alphalab.web.filter.SpaWebFilter;
    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        ...
        http
            .securityMatcher(new NegatedServerWebExchangeMatcher(new OrServerWebExchangeMatcher(
                ...
                pathMatchers(HttpMethod.POST, "/api/rel_user_tournament"),
                pathMatchers(HttpMethod.DELETE, "/api/rel_user_tournament/{id}")
            )))
            .csrf()
        ...
        .and()
            ...
            .pathMatchers("/api/tournaments").permitAll()
            .pathMatchers("/api/rel_user_tournament").permitAll()
            .pathMatchers("/api/admin/**").hasAuthority(AuthoritiesConstants.ADMIN)
            .pathMatchers("/public/**").permitAll()
            .pathMatchers("/services/*/public/**").permitAll()
