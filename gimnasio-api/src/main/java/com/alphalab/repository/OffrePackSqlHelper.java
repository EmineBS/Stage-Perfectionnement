...
public class OffrePackSqlHelper {
    ...
    public static List<Expression> getColumns(Table table, String columnPrefix) {
        ...
        columns.add(Column.aliased("workout_sessions", table, columnPrefix + "_workout_sessions"));
        columns.add(Column.aliased("price", table, columnPrefix + "_price"));
        columns.add(Column.aliased("auto_confirm", table, columnPrefix + "_auto_confirm"));
        columns.add(Column.aliased("rdv_enabled", table, columnPrefix + "_rdv_enabled"));
