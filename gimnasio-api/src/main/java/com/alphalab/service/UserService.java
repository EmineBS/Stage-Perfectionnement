...
import com.alphalab.config.Constants;
import com.alphalab.domain.Authority;
import com.alphalab.domain.User;
import com.alphalab.repository.AuthorityRepository;
import com.alphalab.repository.UserRepository;
import com.alphalab.security.SecurityUtils;
import com.alphalab.service.dto.AdminUserDTO;
...
public class UserService {
    ...
    public User getAuthUser(AbstractAuthenticationToken authToken) {
        Map<String, Object> attributes;
        if (authToken instanceof OAuth2AuthenticationToken) {
            attributes = ((OAuth2AuthenticationToken) authToken).getPrincipal().getAttributes();
        } else if (authToken instanceof JwtAuthenticationToken) {
        ...
        User user = this.getUser(attributes);
        log.debug("Logged user {}:{}", user.toString());
        return user;
    }

    public static User getUser(Map<String, Object> details) {
        User user = new User();
