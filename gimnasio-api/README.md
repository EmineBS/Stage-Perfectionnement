...
> 127.0.0.1 consul
> 127.0.0.1 keycloak
> 127.0.0.1 gimnasio-api
> 127.0.0.1 gimnasio-ui
> 127.0.0.1 pulpo-api
...
npm run infra:dev:up:ps
```

### Run System Via Dapr:

```
npm run dapr:local:up
```

### Test System and Dapr:

Using Dapr CLI:

```
dapr invoke --app-id gimnasio-api --method /health/echo/hello --verb GET
```

Using Curl:

```
curl -X GET http://localhost:35050/health/echo/hello -H "Content-Type: plain/text" -H "dapr-app-id: gimnasio-api"
```

Without Dapr:

```
curl -X GET http://localhost:5050/health/echo/hello -H "Content-Type: plain/text"
```

Public Scan:

```
dapr invoke --app-id gimnasio-api --method public/scan/35de41150fca5072c1df457cc56c17eec91c9e49602efb7ca8a20240aa17d6a5 --verb GET

curl -X GET http://localhost:35050/public/scan/35de41150fca5072c1df457cc56c17eec91c9e49602efb7ca8a20240aa17d6a5 -H "Content-Type: application/json" -H "dapr-app-id: gimnasio-api"

curl -X GET http://localhost:5050/public/scan/35de41150fca5072c1df457cc56c17eec91c9e49602efb7ca8a20240aa17d6a5 -H "Content-Type: application/json"
```
...
```
npm run dapr:full:up
npm run dapr:full:up:ps
```
...
```
npm run dapr:full:down
```

# gimnasio-api [Deprecated README]
...
To build the final jar and optimize the Gimnasio API application for production, run:
...
```
docker-compose -f src/main/docker/dev.yml  up -d --build gimnasio-api-app && docker rm -f gimnasio-api-app-dapr && docker-compose up -d
```

Dapr invoke:

```
dapr invoke --app-id gimnasio-api --method api/public/echo/hello --verb GET

dapr invoke --app-id gimnasio-api --method api/public/scan/35de41150fca5072c1df457cc56c17eec91c9e49602efb7ca8a20240aa17d6a5 --verb GET

dapr invoke --app-id gimnasio-api --method api/public/scan/pulpo/35de41150fca5072c1df457cc56c17eec91c9e49602efb7ca8a20240aa17d6a5 --verb GET
```
...
> docker tag gimnasio-api:latest k3d-registry.alphalab.cloud:5000/gimnasio-api:latest

push image to registry

> docker push k3d-registry.alphalab.cloud:5000/gimnasio-api:latest

deploy app with helm to cluster

> helm upgrade --install -f .cicd/helm/values.yaml backend .cicd/helm
